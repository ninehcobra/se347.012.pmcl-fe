                            ...
                            <div className="dashboard-widget mb-30 mb-lg-0">
                                <div className="user">
                                    <div className="thumb-area">
                                        ...
                                        <label style={{ backgroundColor: '#8739e6' }} for="profile-pic" className="profile-pic-edit"><i className="fa-solid fa-pencil"></i></label>
                                ...
                                <ul className="dashboard-menu">
                                    ...
                                    <li>
                                        <a href="./personalprofile"><i class="fa-solid fa-gears"></i>Personal Profile </a>
                                    </li>
                                    <li>
