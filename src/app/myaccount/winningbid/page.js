            ...
            <div className="dash-bid-item dashboard-widget mb-40-60">
                ...
                <div className="button-area justify-content-between">
                    ...
                    <div className="sort-winning-bid">
                        ...
                        <select name="sort-by" className="select-bar" style={{ display: 'none' }}>
                            <option value="all">All</option>
                            <option value="name">Name</option>
                            <option value="date">Date</option>
                            <option value="type">Type</option>
                            <option value="car">Car</option>
                        </select><div className="nice-select select-bar open" tabIndex="0"><span className="current">All</span><ul className="list"><li data-value="all" className="option selected">All</li><li data-value="name" className="option">Name</li><li data-value="date" className="option">Date</li><li data-value="type" className="option">Type</li><li data-value="car" className="option">Car</li></ul></div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="auction-content">
                            ...
                            <div className="countdown-area">
                                <div className="countdown">
                                    <div id="bid_counter26">0d  : 14h  : 49m  : 28s</div>
                                </div>
                ...
                <div className="col-sm-10 col-md-6">
                    <div className="auction-item-2">
                        ...
                        <div className="auction-content">
                            ...
                            <div className="countdown-area">
                                <div className="countdown">
                                    <div id="bid_counter27">0d  : 14h  : 49m  : 28s</div>
                                </div>
                                <span className="total-bids">30 Bids</span>
                            </div>
                            <div className="text-center">
                ...
                <div className="col-sm-10 col-md-6">
                    <div className="auction-item-2">
                        ...
                        <div className="auction-content">
                            ...
                            <div className="countdown-area">
                                <div className="countdown">
                                    <div id="bid_counter1">0d  : 14h  : 49m  : 28s</div>
                                </div>
                                <span className="total-bids">30 Bids</span>
                            </div>
                            <div className="text-center">
                ...
                <div className="col-sm-10 col-md-6">
                    <div className="auction-item-2">
                        ...
                        <div className="auction-content">
                            ...
                            <div className="countdown-area">
                                <div className="countdown">
                                    <div id="bid_counter2">0d  : 14h  : 49m  : 28s</div>
                                </div>
                                <span className="total-bids">30 Bids</span>
                            </div>
                            <div className="text-center">
                        ...
                        <div id="extwaiokist" style={{ display: 'none' }} v="nipgg" q="2a2a9de0" c="8.710" i="19" u="27.09" s="11202301" sg="svr_09102316-ga_11202301-bai_11222322" d="1" w="false" e="" a="3" m="BMe=" vn="9adfy"><div id="extwaigglbit" style={{ display: 'none' }} v="nipgg" q="2a2a9de0" c="8.710" i="19" u="27.09" s="11202301" sg="svr_09102316-ga_11202301-bai_11222322" d="1" w="false" e="" a="3" m="BMe="></div></div></div>
                </div>
            </div>
        </div>
    )
