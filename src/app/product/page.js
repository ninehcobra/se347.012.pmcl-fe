            ...
            <section className="product-details padding-bottom mt--240 mt-lg--440">
                <div className="container">
                    <div className="product-details-slider-top-wrapper">
                        <div className="product-details-slider owl-theme owl-carousel owl-loaded owl-drag" id="sync1">
                            ...
                            <div className="owl-stage-outer"><div className="owl-stage" ><div className="owl-item cloned" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product4.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item cloned" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product5.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item cloned" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product6.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product1.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product2.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product3.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item" style={{ width: '1140px' }}><div className="slide-top-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/product4.png" alt="product" />
                                ...
                                <div id="extwaiokist" style={{ display: 'none' }} v="nipgg" q="2a2a9de0" c="9.007" i="19" u="4.174" s="11202301" sg="svr_09102316-ga_11202301-bai_11222322" d="1" w="false" e="" a="3" m="BMe=" vn="9adfy"><div id="extwaigglbit" style={{ display: 'none' }} v="nipgg" q="2a2a9de0" c="9.007" i="19" u="4.174" s="11202301" sg="svr_09102316-ga_11202301-bai_11222322" d="1" w="false" e="" a="3" m="BMe="></div></div></div></div></div></div><div className="owl-nav disabled"><div className="owl-prev">prev</div><div className="owl-next">next</div></div><div className="owl-dots disabled"></div><div className="owl-thumbs"></div></div>
                    </div>
                    <div className="product-details-slider-wrapper">
                        <div className="product-bottom-slider owl-theme owl-carousel owl-loaded owl-drag" id="sync2">
                            ...
                            <div className="owl-stage-outer"><div className="owl-stage"><div className="owl-item active synced" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/01.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/02.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/03.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/04.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/05.png" alt="product" />
                                </div>
                            </div></div><div className="owl-item active" style={{ width: '168.333px' }}><div className="slide-bottom-item">
                                <div className="slide-inner">
                                    <img src="https://pixner.net/sbidu/main/assets/images/product/06.png" alt="product" />
                                </div>
                            </div></div></div></div><div className="owl-nav disabled"><div className="owl-prev">prev</div><div className="owl-next">next</div></div><div className="owl-dots disabled"></div><div className="owl-thumbs"></div></div>
